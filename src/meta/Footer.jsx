    ...
    <>
      <footer className="w-full px-5.5 pb-40">
        <Reveal preset="fadeUp" className="w-full max-w-3xl mx-auto">
          <div className="grid gap-4 md:grid-cols-[1fr_auto] items-start text-neutral-800">
            <div className="space-y-2">
              <p className="font-semibold text-black">TKJ - SMKN 1 Seyegan</p>
              <p className="max-w-lg">
                Learning by doing with telecommunication, network engineering,
                and professional documentation for real-world student projects.
              </p>
              <p className="text-sm text-neutral-600">
                State Vocational High School 1 Seyegan, Jl. Kebonagung KM 8, RW
                5, Mriyan, Margomulyo, Seyegan, Sleman, DI Yogyakarta 55561
              </p>
            </div>
            <ul className="flex flex-col gap-3 justify-center md:justify-end list-none p-0 m-0">
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="px-3 py-1 rounded-full transition-colors inline-flex items-center gap-2"
                >
              ...
              <li>
                <a
                  href="https://tkjskanesga.mintlify.site"
                  target="_blank"
                  rel="noreferrer"
                  className="px-3 py-1 rounded-full transition-colors inline-flex items-center gap-2"
                >
        ...
        <div className="w-full text-center mt-6 text-neutral-700 text-xs">
          <p>
            © <span ref={timeRef}>2026</span> TKJ Skanesga. All rights reserved.
          </p>
        </div>
      </footer>
