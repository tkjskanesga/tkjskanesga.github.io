      ...
      <Reveal preset="fadeUp" className="w-full max-w-3xl mx-auto">
        <div className="grid gap-4 md:grid-cols-[1fr_auto] items-start text-neutral-800">
          <div className="space-y-2">
            ...
            <p className="text-sm text-neutral-600">State Vocational High School 1 Seyegan, Jl. Kebonagung KM 8, RW 5, Mriyan, Margomulyo, Seyegan, Sleman, DI Yogyakarta 55561</p>
          </div>
